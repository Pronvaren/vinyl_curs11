...
{
    public partial class dobav_genre : Form
    {
        ...
        public dobav_genre(string fio, string role)
        {
            InitializeComponent();
        ...
        private void dobav_genre_Load(object sender, EventArgs e)
        {
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string checkSql = "SELECT COUNT(*) FROM Genres WHERE Name = '" + textBox4.Text + "'";
                    ...
                    {
                        string sql = "INSERT INTO Genres (Name) VALUES ('" + textBox4.Text + "')";
