...
namespace vinyl_curs
{
    public partial class artist : Form
    {
        ...
        public artist(string fio, string role)
        {
            InitializeComponent();
        ...
        private void artist_Load(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connStr))
            {
                ...
                string query = @"
                    SELECT id AS 'ID', Name AS 'Название' FROM Artists
                ";
                ...
                dataGridView1.ColumnHeaderMouseClick += (s, eArgs) => { };
        ...
        {
            dobav_artist dobav_artist = new dobav_artist(userFio, userRole);
            this.Hide();
            dobav_artist.ShowDialog();
            this.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            izm_artist izm_artist = new izm_artist(userFio, userRole, id, name);
            this.Hide();
            izm_artist.ShowDialog();
            this.Close();
        }
