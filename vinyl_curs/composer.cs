...
namespace vinyl_curs
{
    public partial class composer : Form
    {
        ...
        public composer(string fio, string role)
        {
            InitializeComponent();
        ...
        private void composer_Load(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connStr))
            {
                ...
                string query = @"
                    SELECT id AS 'ID', Name AS 'Название' FROM Composers
                ";
        ...
        {
            dobav_composer dobav_composer = new dobav_composer(userFio, userRole);
            this.Hide();
            dobav_composer.ShowDialog();
            this.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            izm_composer izm_composer = new izm_composer(userFio, userRole, id, name);
            this.Hide();
            izm_composer.ShowDialog();
            this.Close();
        }
    }
}
