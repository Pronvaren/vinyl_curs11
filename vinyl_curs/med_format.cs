...
{
    public partial class med_format : Form
    {
        ...
        public med_format(string fio, string role)
        {
            InitializeComponent();
        ...
        private void med_format_Load(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(connStr))
            {
                ...
                string query = @"
                    SELECT id AS 'ID', Name AS 'Название' FROM MediaFormats
                ";
        ...
        {
            dobav_med_form dobav_med_form = new dobav_med_form(userFio, userRole);
            this.Hide();
            dobav_med_form.ShowDialog();
            this.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            izm_med_form izm_med_form = new izm_med_form(userFio, userRole, id, name);
            this.Hide();
            izm_med_form.ShowDialog();
            this.Close();
        }
    }
}
