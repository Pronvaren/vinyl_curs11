...
{
    public partial class dobav_role : Form
    {
        ...
        public dobav_role(string fio, string role)
        {
            InitializeComponent();
        ...
        private void dobav_role_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string checkSql = "SELECT COUNT(*) FROM Roles WHERE Name = '" + textBox4.Text + "'";
                    ...
                    {
                        string sql = "INSERT INTO Roles (Name) VALUES ('" + textBox4.Text + "')";
