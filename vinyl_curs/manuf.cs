...
namespace vinyl_curs
{
    public partial class manuf : Form
    {
        ...
        public manuf(string fio, string role)
        {
            InitializeComponent();
        ...
        private void manuf_Load(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connStr))
            {
                ...
                string query = @"
                    SELECT id AS 'ID', Name AS 'Название' FROM Manufacturers
                ";
        ...
        {
            dobav_manuf dobav_manuf = new dobav_manuf(userFio, userRole);
            this.Hide();
            dobav_manuf.ShowDialog();
            this.Close();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            izm_manuf izm_manuf = new izm_manuf(userFio, userRole, id, name);
            this.Hide();
            izm_manuf.ShowDialog();
            this.Close();
        }
    }
}
