...
{
    public partial class izm_composer : Form
    {
        ...
        public izm_composer(string fio, string role, int id, string name)
        {
            InitializeComponent();
        ...
        private void izm_composer_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    {
                        conn.Open();
                        string sql = "UPDATE Composers SET Name = '" + textBox4.Text + "' WHERE id = " + compId;
